...
namespace Arbor
{
	...
	public class ParameterConditionLegacy : ISerializationCallbackReceiver
	{
		#region enum
...
#endif
		[SerializeField]
		internal FlexibleColor _ColorValue = new FlexibleColor();
...
#region old
		...
		public const int kNewestSerializeVersion = 1;
				...
				case Parameter.Type.Transform:
					{
						...
						if (parameter.objectReferenceValue == transformValue)
						{
							return true;
						}
					}
				...
				case Parameter.Type.RectTransform:
					{
						...
						if (parameter.objectReferenceValue == rectTransformValue)
						{
							return true;
						}
					}
				...
				case Parameter.Type.Rigidbody:
					{
						...
						if (parameter.objectReferenceValue == rigidbodyValue)
						{
							return true;
						}
					}
				...
				case Parameter.Type.Rigidbody2D:
					{
						...
						if (parameter.objectReferenceValue == rigidbody2DValue)
						{
							return true;
						}
					}
