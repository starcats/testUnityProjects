...
namespace ArborEditor
{
	...
	class SendMessageArgumentProperty
	{
	...
	class SendMessageArgumentPropertyEditor : PropertyEditor
	{
	...
	class SendMessageArgumentPropertyDrawer : PropertyEditorDrawer<SendMessageArgumentPropertyEditor>
	{
	}
}