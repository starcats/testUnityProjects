...
namespace ArborEditor
{
	...
	public class ParameterConditionLegacyProperty
	{
		...
		private SerializedProperty _ComponentValueValueProperty;
		...
		public SerializedProperty componentValueProperty
		{
			get
			{
				if (_ComponentValueValueProperty == null)
				{
					_ComponentValueValueProperty = property.FindPropertyRelative(kComponentValuePath);
				}
				return _ComponentValueValueProperty;
			}
		}
